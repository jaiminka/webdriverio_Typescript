 ...
 */
exports.default = (function (isCSS, attrName, elem, falseCase, expectedValue) { return __awaiter(void 0, void 0, void 0, function () {
    var command, attrType, attributeValue;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                command = isCSS ? 'getCSSProperty' : 'getAttribute';
                attrType = (isCSS ? 'CSS attribute' : 'Attribute');
                return [4 /*yield*/, $(elem)[command](attrName)];
            case 1:
                ...
                if (falseCase) {
                    expect(attributeValue).not.toBe(expectedValue, 
                    // @ts-expect-error
                    "".concat(attrType, ": ").concat(attrName, " of element \"").concat(elem, "\" should not ")
                        + "contain \"".concat(attributeValue, "\""));
                }
                else {
                    expect(attributeValue).toBe(expectedValue, 
                    // @ts-expect-error
                    "".concat(attrType, ": ").concat(attrName, " of element \"").concat(elem, "\" should contain ")
                        + "\"".concat(attributeValue, "\", but \"").concat(expectedValue, "\""));
                }
                return [2 /*return*/];
        }
    });
