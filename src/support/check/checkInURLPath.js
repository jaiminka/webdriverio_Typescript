 ...
 */
exports.default = (function (falseCase, expectedUrlPart) { return __awaiter(void 0, void 0, void 0, function () {
    var currentUrl;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                currentUrl = _a.sent();
                if (falseCase) {
                    expect(currentUrl).not.toContain(expectedUrlPart, 
                    // @ts-expect-error
                    "Expected URL \"".concat(currentUrl, "\" not to contain ")
                        + "\"".concat(expectedUrlPart, "\""));
                }
                else {
                    expect(currentUrl).toContain(expectedUrlPart, 
                    // @ts-expect-error
                    "Expected URL \"".concat(currentUrl, "\" to contain \"").concat(expectedUrlPart, "\""));
                }
                return [2 /*return*/];
        }
    });
