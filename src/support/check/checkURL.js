 ...
 */
exports.default = (function (falseCase, expectedUrl) { return __awaiter(void 0, void 0, void 0, function () {
    var currentUrl;
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (falseCase) {
                    expect(currentUrl)
                        // @ts-expect-error
                        .not.toEqual(expectedUrl, "expected url not to be \"".concat(currentUrl, "\""));
                }
                else {
                    expect(currentUrl).toEqual(expectedUrl, 
                    // @ts-expect-error
                    "expected url to be \"".concat(expectedUrl, "\" but found ")
                        + "\"".concat(currentUrl, "\""));
                }
                return [2 /*return*/];
        }
