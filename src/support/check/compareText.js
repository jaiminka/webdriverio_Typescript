 ...
 */
exports.default = (function (selector1, falseCase, selector2) { return __awaiter(void 0, void 0, void 0, function () {
    var text1, text2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, $(selector1).getText()];
            case 1:
                text1 = _a.sent();
                return [4 /*yield*/, $(selector2).getText()];
            case 2:
                text2 = _a.sent();
                if (falseCase) {
