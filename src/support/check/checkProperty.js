 ...
 */
exports.default = (function (isCSS, attrName, selector, falseCase, expectedValue) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, $(selector)[command](attrName)];
            case 1:
                ...
                if (falseCase) {
                    ...
                    // @ts-expect-error
                    "".concat(attrType, ": ").concat(attrName, " of element \"").concat(selector, "\" should ")
                        + "not contain \"".concat(attributeValue, "\""));
                }
                else {
                    expect(attributeValue).toEqual(expectedValue, 
                    // @ts-expect-error
                    "".concat(attrType, ": ").concat(attrName, " of element \"").concat(selector, "\" should ")
                        + "contain \"".concat(attributeValue, "\", but \"").concat(expectedValue, "\""));
                }
                return [2 /*return*/];
        }
    });
