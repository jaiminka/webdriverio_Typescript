 ...
 */
exports.default = (function (modalType, falseState) { return __awaiter(void 0, void 0, void 0, function () {
    var promptText, e_1;
        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                if (falseState) {
                    ...
                    // @ts-expect-error
                    "A ".concat(modalType, " was opened when it shouldn't"));
                }
                return [3 /*break*/, 4];
            case 3:
                e_1 = _a.sent();
                if (!falseState) {
                    ...
                    // @ts-expect-error
                    "A ".concat(modalType, " was not opened when it should have been"));
                }
                return [3 /*break*/, 4];
