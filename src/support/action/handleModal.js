 ...
 */
exports.default = (function (action, modalType) { return __awaiter(void 0, void 0, void 0, function () {
    var command;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                command = "".concat(action.slice(0, 1).toLowerCase()).concat(action.slice(1), "Alert");
                /**
                ...
                return [4 /*yield*/, browser[command]()];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
