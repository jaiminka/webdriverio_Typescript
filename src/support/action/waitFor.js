 ...
 *                                             existence)
 */
exports.default = (function (selector, ms, falseState, state) { return __awaiter(void 0, void 0, void 0, function () {
    var intMs, command, boolFalseState, parsedState;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                intMs = parseInt(ms, 10) || 3000;
                command = 'waitForExist';
                boolFalseState = !!falseState;
                parsedState = '';
                if (falseState || state) {
                    parsedState = state.indexOf(' ') > -1
                        ...
                        : state;
                    if (parsedState) {
                        command = "waitFor".concat(parsedState[0].toUpperCase())
                            + "".concat(parsedState.slice(1));
                    }
                }
                if (typeof falseState === 'undefined') {
                    boolFalseState = false;
                }
                return [4 /*yield*/, $(selector)[command]({
                        timeout: intMs,
