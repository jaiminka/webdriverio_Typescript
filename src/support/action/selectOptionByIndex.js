 ...
 */
exports.default = (function (index, obsolete, selector) { return __awaiter(void 0, void 0, void 0, function () {
    var optionIndex;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                optionIndex = parseInt(index, 10);
                return [4 /*yield*/, $(selector).selectByIndex(optionIndex)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
