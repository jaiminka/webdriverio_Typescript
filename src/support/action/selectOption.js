 ...
 */
exports.default = (function (selectionType, selectionValue, selector) { return __awaiter(void 0, void 0, void 0, function () {
    var command, commandArguments;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                commandArguments = [selectionValue];
                ...
                return [4 /*yield*/, (_a = $(selector))[command].apply(_a, commandArguments)];
            case 1:
                _b.sent();
                return [2 /*return*/];
        }
